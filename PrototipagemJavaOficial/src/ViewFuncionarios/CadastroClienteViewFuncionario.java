...
public class CadastroClienteViewFuncionario extends JInternalFrame {
	...
	private void initialize() {
		...
		lblVarejoSantos.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-p\u00E1gina-inicial-25.png")));
		...
		btnNewButton_3.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-gest\u00E3o-de-cliente-25.png")));
		...
		btnCadastroDeFornecedores.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-caminh\u00E3o-25.png")));
		...
		btnCadastroDeProdutos.setIcon(
				new ImageIcon(CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-produto-25.png")));
		...
		btnEstoque.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-procurar-estoque-25.png")));
		...
		lblCadastroCliente.setIcon(new ImageIcon(CadastroClienteViewFuncionario.class
				.getResource("/imagens/icons8-gest\u00E3o-de-cliente-filled-25.png")));
		...
		btnNewButton.setIcon(
				new ImageIcon(CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-salvar-25 (2).png")));
		...
		btnPesquisar.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-pesquisar-filled-25.png")));
		...
		btnLimpar.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-vassoura-filled-25.png")));
		...
		btnAtualizar.setIcon(new ImageIcon(
				CadastroClienteViewFuncionario.class.getResource("/imagens/icons8-actualizar-25 (1).png")));
