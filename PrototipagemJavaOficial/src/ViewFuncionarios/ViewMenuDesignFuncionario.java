...
public class ViewMenuDesignFuncionario extends JFrame {
	...
	public ViewMenuDesignFuncionario() {
		...
		button.setIcon(new ImageIcon(
				ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-gest\u00E3o-de-cliente-25.png")));
		...
		button_1.setIcon(
				new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-procurar-estoque-25.png")));
		...
		button_2.setIcon(
				new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-caminh\u00E3o-25.png")));
		...
		label.setIcon(new ImageIcon(
				ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-p\u00E1gina-inicial-25.png")));
		...
		btnNewButton_1.setIcon(
				new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-ver-detalhes-25.png")));
		...
		btnNewButton
				.setIcon(new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-mais-25 (1).png")));
		...
		btnatualizar.setIcon(
				new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-actualizar-25 (1).png")));
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
						.addComponent(button_1, GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE).addContainerGap()));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addGap(39).addComponent(label).addGap(18)
						...
						.addComponent(button_1, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE).addGap(123)
		...
		lblNewLabel_1.setBounds(596, 10, 57, 28);
		panel_1.add(lblNewLabel_1);
		lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1
				.setIcon(new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-sair-25 (1).png")));
		...
		btnDeletarLembrete
				.setIcon(new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-excluir-25.png")));
		...
		btnExcluirTodosLembretes.setIcon(
				new ImageIcon(ViewMenuDesignFuncionario.class.getResource("/imagens/icons8-vassoura-filled-25.png")));
