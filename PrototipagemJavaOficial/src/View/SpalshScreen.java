...
import Controller.LembreteValidadeController;
...
public class SpalshScreen extends JFrame {
	...
	private void lembrete() throws Exception {
		LembreteValidadeController controller = new LembreteValidadeController();
		controller.lembreteValidade();
