		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					//frameVendas.setExtendedState(JFrame.MAXIMIZED_BOTH);
...
menu.setLocationRelativeTo(null);
		...
		codigoVen.setEnabled(false);
		codigoVen.setBounds(298, 136, 56, 26);
		codigoVen.setColumns(10);

		JLabel lblCdigoDaVenda = new JLabel("N\u00BA DA VENDA:");
		...
		txtPesoProd.setBounds(527, 229, 92, 26);
