...
public class CadastroUsuarioView extends JFrame {
	...
	public CadastroUsuarioView() {
		...
		txtlogin.setBackground(new Color(0, 128, 128));
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			private void validarSenhaAdm() throws Exception {
				...
				// boolean teste = txtsenhaadm.getText() == "1345461153354";

				// teste = controller.senhaAdministrador(txtsenhaadm.getText());
		...
		txtsenhaadm.addKeyListener(new KeyAdapter() {

		});
		txtsenhaadm.setForeground(Color.WHITE);
		txtsenhaadm.setBorder(null);
		txtsenhaadm.setBackground(new Color(0, 128, 128));
