...
public class Fornecedor extends JFrame {
	...
	private void initialize() {
		...
		JLabel lblEmpresa = new JLabel("NOME:");
		...
		panel_2.setBounds(299, 416, 673, 294);
		...
		btnCadastrar.setIcon(new ImageIcon(Fornecedor.class.getResource("/imagens/icons8-salvar-25 (2).png")));
		...
		btnCadastrar.setBounds(300, 722, 124, 37);
